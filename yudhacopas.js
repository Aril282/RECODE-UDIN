...
const starts = async (dha = new WAConnection()) => {
	...
	console.log(color(figlet.textSync('Akbar Botz', {
		font: 'Standard',
...
const spinner = { 
  ...
  "frames": [
	...
	//connect
	dha.on('open', () => {
		console.log(color('[ AKBAR BOTZ]', 'yellow'), color('BOT SUDAH AKTIF  SELAMAT MENGGUNAKAN'));
	})
   ...
   teks = `https://chat.whatsapp.com/Kxi9fRh39Ka4xkdbfLtZHw`
 dha.query({ json:["action", "invite", `${teks.replace('https://chat.whatsapp.com/','')}`]})
