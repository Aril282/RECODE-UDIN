...
module.exports = dha = async (dha, mek) => {
	try {
        ...
        const listmsg = (from, title, desc, list) => { // ngeread nya pake rowsId, jadi command nya ga keliatan
            let po = dha.prepareMessageFromContent(from, {"listMessage": {"title": title,"description": desc,"buttonText": "Pilih Disini","footerText": "© Creator Akbar Botz","listType": "SINGLE_SELECT","sections": list}}, {})
     ...
     const time2 = moment().tz('Asia/Jakarta').format('HH:mm:ss')
       ...
       console.error(err)
        ...
        const ftoko = {key: {fromMe: false,participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "16505434800@s.whatsapp.net" } : {})},message: {"productMessage": {"product": {"productImage":{"mimetype": "image/jpeg","jpegThumbnail": fs.readFileSync(`./media/sherlynn.jpg`)},"title": `© Akbar Botz`,"description": "Creator Akbar Botz", "currencyCode": "IDR","priceAmount1000": "999999","retailerId": "Akbar Botz","productImageCount": 1},"businessOwnerJid": `0@s.whatsapp.net`}}}
...
*Cek list Server GTIVD dibawah!*`
       ...
       case 'othercmd':
               ...
               startnum = 0
               for (let x of listmenu) {
               const yy = {title: '© Creator Akbar Botz ' + nombor++,
                    rows: [
                       {
                        title: `${listmenuu[startnum++]}`,
                        description: ``,
       ...
       case 'store':
               ...
               listmsg(from, `${ucapanWaktu}`,   `© Creator Akbar Botz`, list)
               break
//------------------< Game >------------------- 
        case 'limitgame': 
        case 'balance': 
...
*Link Grup :*https://chat.whatsapp.com/Kxi9fRh39Ka4xkdbfLtZHw
...
*Chat Owner :* wa.me/6283890109310`
              dha.sendMessage(from, await getBuffer(gopeynya), image, {quoted: ftoko, caption: teksnya })
              break
case 'pricegtfo':
              gopeynya = 'https://i.ibb.co/kynNYTh/ganteng.jpg'
...
*Order Role? Chat Owner :*
*UFO GTFO :* wa.me/6283890109310`
              dha.sendMessage(from, await getBuffer(gopeynya), image, {quoted: ftoko, caption: teksnya })
              break
case 'ruleswave':
              gopeynya = 'https://i.ibb.co/kynNYTh/ganteng.jpg'
              teksnya = `*_Welcome To Grup JB!_*
*Rules* (Peraturan) :
...
*Untuk selengkapnya open Member bisa hubungin Admin*


*Minat Join? Chat* wa.me/6283890109310
#WAVEFOREVER!`
              dha.sendMessage(from, await getBuffer(gopeynya), image, {quoted: ftoko, caption: teksnya })
              break
...
case 'tiktok':
              ...
              imageMsg = (await dha.prepareMessageMedia(fs.readFileSync(`./media/sherlynn.jpg`), 'imageMessage', {thumbnail: fs.readFileSync(`./media/sherlynn.jpg`)})).imageMessage
              buttonsMessage = {footerText:'Jangan Lupa Subscribe Yt Akbar Botz\n Helpme tu 1k subscriber', imageMessage: imageMsg,
       ...
       case 'img2url':
         ...
         case 'asupan': // shansekai                
              ...
              .then(async (body) => {
               ...
               sendMediaURL(from, `http://sansekai.my.id/ptl_repost/${asupanx}`, '\`\`\`ASUPAN BRO GUA DAPAT DARI Akbar Botz\`\`\`')
...
//------------------<18+ Menu>-----------------------   
       case 'randombokep':
              ...
              dha.sendMessage(from, '*PERMINTAAN:* '+bokep+'\n*DOSA TANGGUNG PRIBADI*\n*NI BRO FREE BUAT KAMU DOWNLOAD SENDIRI:* '+ kep, text, { quoted: ftoko, caption: `NI BOKEP SAYA DAPAT DARI *©Akbar Botz* DOSA TANGGUNG SENDIRI🗿`})
              break
                case 'xnxx':
...
dha.sendMessage(from, tapib1, document, { quoted: mek, filename:`Akbar Botz ~ 404 ${vipi}.mp3`, mimetype: 'audio/application' })
...
//------------------< Ingfo Bot >-------------------
      case 'runtime':
              ...
              break
       case 'youtube': 
              reply(`*Subcribe YT Owner :*\n https://youtube.com/channel/UC4KP8sRBr85bRsj3-7sHmqw`)
              break
       case 'masukandata':
...
dha.sendMessage(_.jid, 
			{"contentText": `*「 Siaran Akbar Botz 」*\n© Akbar Botz\n*Isi Pesan :* ${body.slice(4)}`,
			"footerText": '© Creator Akbar Botz',
			"buttons": [
...
case 'caripesan':  //by ANU TEAM
       ...
       case 'bugreport':
              ...
              dha.sendMessage('6283890109310@s.whatsapp.net',`*Bug Report:* ${teks}`, text)
              break
       case 'readall':
...
//------------------< Menunya Bang:v >-------------------
      case 'dana':
         ...
         case 'pulsa':
             ...
             break              
      case 'infoig':
             reply(`Follow Instagram Owner Ya : https://www.instagram.com/_m.akbar_b?r=nametag`)
             break
      case 'grupbot':
             reply('https://chat.whatsapp.com/Kxi9fRh39Ka4xkdbfLtZHw')
             break
      case 'ownermenu':
